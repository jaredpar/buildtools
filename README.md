...
[![Build Status](http://dotnet-ci.cloudapp.net/buildStatus/icon?job=dotnet_buildtools/master/innerloop)](http://dotnet-ci.cloudapp.net/job/dotnet_buildtools/job/master/job/innerloop/)
